...
@shared_task
def send_distress_signal(phone_number, live_tracking_url):
    message = f"Urgent: Your contact is in danger! Track their location here: {live_tracking_url}"
    print(message)  # Replace this with actual SMS sending code
